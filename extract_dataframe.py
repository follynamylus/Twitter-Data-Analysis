...
class TweetDfExtractor:
    ...
    def find_statuses_count(self)->list:
        status_count = [x['status_count'] for x in self.tweets_list]
        return status_count
    ...
    def is_sensitive(self)->list:
        ...
        for i in self.tweets_list:
            if 'possibly_sensitive' in i.keys():
                possibly.append(i['possibly_sensitive'])
            else :
                possibly.append(None)
    ...
    def find_mentions(self)->list:
        mentions = []
        for i in self.tweets_list : 
            mentions.append(','.join([x['screen_name'] for x in i['entities']['user_mentions']]))
        return mentions
