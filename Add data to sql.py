...
def DBConnect(dbName=None):
    ...
    """
    conn = mysql.connect(host='localhost', user='root', password='know@edge',
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('processed_tweet.csv')

    insert_to_tweet_table(dbName='twitter', df=df, table_name='EconomicTweets')
